              ...
              <div class="widget-content padded">
		        <form action="" method="post" class="form-horizontal">
		         	...
		         	<div class="form-group">
			            ...
			            <div class="col-md-2">
			              <input class="form-control" placeholder="Escriba el apellido" name="identification_number" type="text" required>
			            </div>
		         	...
		         	<div class="form-group">
			            ...
			            <div class="col-md-3">
			              <input class="form-control" placeholder="Escriba el correo" name="email" type="text" required>
			            </div>

			            <label class="control-label col-md-1">Teléfono</label>
			            <div class="col-md-3">
			              <input class="form-control" placeholder="Escriba el telefono" name="phone" type="text" required>
			            </div>
