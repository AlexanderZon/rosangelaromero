              ...
              <div class="widget-content padded">
		        <form action="" method="post" class="form-horizontal">
		          <div class="form-group">
			            ...
			            <div class="col-md-7">
			              <input class="form-control" placeholder="Escriba el nombre de la persona" name="first_name" type="text"/>
			            </div>
			        </div>
					<div class="form-group">
			            <label class="control-label col-md-2">Apellido</label>
			            <div class="col-md-7">
			              <input class="form-control" placeholder="Escriba el apellido de la persona" name="last_name" type="text">
			            </div>
			        </div>
					<div class="form-group">
					...
					<div class="form-group">
			            ...
			            <div class="col-md-7">
			              <input class="form-control" placeholder="Escriba el usuario de la persona" name="email" type="email">
			            </div>
			        </div>
			        @if(isset($error) AND $error == 'password_error')
